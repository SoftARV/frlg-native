...
int main(int argc, char **argv)
{
    ...
    // size, not for a certain count of them, and six is what puts them back at
    // roughly that size on a 1080p display. host_video_open brings it down if
    // the window would not fit.
